...
import { ILoadedEventArgs, ChartTheme, HistogramSeriesService, TooltipService } from '@syncfusion/ej2-angular-charts'

@Component({
  selector: 'app-blank',
  templateUrl: './chart.component.html',
  styleUrls: ['./chart.component.css'],
  providers: [HistogramSeriesService, TooltipService]
})
